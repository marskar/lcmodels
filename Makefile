...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"lcmodels","description":"A short description of the project."}'
	test -f README.rst || echo "lcmodels" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/lcmodels.git
